...
public class PlayerNetworkRequestUtils {
    ...
    public void playPermissionCheck(String requestJson,Callback<ResponseBody> callback){
        ...
        RequestBody requestBody = RequestBody.create(MediaType.parse("Content-Type, application/json"),requestJson);

//        Call<ResponseBody> call = NetClient.INSTANCE.getPlayPermissionCheckApi().getCheckResult(requestBody);
//        Log.e("permissionCheck",call.request().toString());
//        call.enqueue(callback);
    }

//    public ProgramDetailInfo parsePlayPermissionCheckResult(String jsonInfo){
//        ProgramDetailInfo mProgramDetailInfo =new ProgramDetailInfo();
//        List<MediaCDNInfo> mediaCDNInfoList =new ArrayList<>();
//        Log.e(TAG, jsonInfo+"--");
