 ...
 */
public class ProgrameSeriesAdapter extends BaseRecyclerAdapter<ProgramSeriesInfo.ProgramsInfo, ProgrameSeriesAdapter.ProgrameSeriesViewHolder> {
    ...
    public ProgrameSeriesAdapter(Context context, OnRecycleItemClickListener listener) {
...
//            }
    ...
    @Override
    public ProgrameSeriesAdapter.ProgrameSeriesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ProgrameSeriesViewHolder viewHolder = new ProgrameSeriesViewHolder(LayoutInflater.from(context).inflate(R.layout.layout_programe_series, null));
        return viewHolder;
    }
                ...
                public boolean onKey(View v, int keyCode, KeyEvent event) {
                    ...
                    if (event.getAction()==KeyEvent.ACTION_UP){
                        ...
                        if (keyCode == KeyEvent.KEYCODE_ENTER || keyCode == KeyEvent.KEYCODE_DPAD_CENTER) {
                            ...
                            listener.onItemClick(v, getAdapterPosition(), getItem(getAdapterPosition()));
