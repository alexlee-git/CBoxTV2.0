...
public class PersonFragment extends BaseFragment {
    ...
    private String contentType = "FG";
    private TextView mPersonLabelTitle;
    private View mLabelFocusView;
    private String mKeywordType = "name";
    private PersonSizeListener personSizeListener;
    public  interface  PersonSizeListener{

        void  PersonSize(int size);
    }

    public void setPersonSizeListener(PersonSizeListener personSizeListener){
        if (personSizeListener!=null){
            this.personSizeListener = personSizeListener;
        }

    }
    public static PersonFragment newInstance(Bundle paramBundle) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (SearchRecyclerView) view.findViewById(R.id.id_search_result_person_recyclerView);
        mResultTotalView = (TextView) view.findViewById(R.id.id_fragment_person_result_total);
        mEmptyView = (TextView) view.findViewById(R.id.id_search_result_person_empty);
...
//                mDatas = new ArrayList<>();
    ...
    public void setPersonLabelTitle(TextView view) {
        mPersonLabelTitle = view;
    }
        ...
        try {
            if (result != null) {
                if (result.getResultList() != null && result.getResultList().size() > 0) {
                    ...
                    mLoadMore = true;
                    PersonAdapter adapter = (PersonAdapter) mRecyclerView.getAdapter();
                    if (adapter == null) {
                        mDatas = result.getResultList();
                        adapter = new PersonAdapter(mContext, mDatas);
//                adapter.setHasStableIds(true);
            ...
            NetClient.INSTANCE.getSearchResultApi().getKeywordSearchResultResponse(Constant.APP_KEY, Constant.CHANNEL_ID, contentType, keyword, keywordType, programType, startNum, size).subscribeOn(Schedulers.io())
                ...
                public void onNext(ResponseBody value) {
                    try {
                        ...
                        if (personSizeListener!=null){
                            personSizeListener.PersonSize(mSearchResultInfos.getResultList().size());
                        }
    ...
    class PersonAdapter extends RecyclerView.Adapter<PersonViewHolder> {
        ...
        public PersonAdapter(Context context, List<SearchResultInfos.ResultListBean> list) {
            mContext = context;
            mDatas = list;
        }
        ...
        public PersonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.newtv_search_result_fragment_person_item, parent, false);
            PersonViewHolder mPersonViewHolder = new PersonViewHolder(view);
                ...
                if (mDatas == null || mDatas.size() <= 0) {
                    ...
                    holder.mFrameLayoutResultList.setOnFocusChangeListener(new View.OnFocusChangeListener() {
                        ...
                        public void onFocusChange(View view, boolean hasFocus) {
                            ...
                            if (hasFocus) {
                                onItemGetFocus(view);
                                mPersonLabelTitle.setTextColor(Color.parseColor("#13d6f9"));
                                mFocusStatus = true;
...
//                            mContext.startActivity(intent);
                                ...
                                if (i == KeyEvent.KEYCODE_DPAD_RIGHT) {
                                    ...
                                    if (position % 6 == 0) {
                                        if (mKeyboardLastFocusView != null) {
                                            ...
                                            mPersonLabelTitle.setTextColor(Color.parseColor("#ededed"));
    ...
    class PersonViewHolder extends RecyclerView.ViewHolder {
        ...
        public PersonViewHolder(View itemView) {
            super(itemView);
            mFrameLayoutResultList = (FrameLayout) itemView.findViewById(R.id.id_frameLayout_person_list);
            mTxtTitle = (TextView) itemView.findViewById(R.id.id_person_title);
            mPosterTitle = (TextView) itemView.findViewById(R.id.id_person_poster_title);
            mPosterImageView = (ImageView) itemView.findViewById(R.id.id_person_imageView_poster);
            mFocusImageView = (ImageView) itemView.findViewById(R.id.id_person_imageView_focus);
            //适配
