...
public class ProgramDetailInfo implements Serializable {
    ...
    private List<MediaCDNInfo> data ;
    ...
    public ProgramDetailInfo(String contentUUID, String MAMID, String title, String contentType, String contentUrl, String subTitle, String duration, String videoType, String videoClass, String tags, String vipFlag, String vipProductId, String movieLevel, String definition, String vipNumber, String sortType, String playOrder, String permiereTime, String permiereChannel, String prize, String issueDate, String leadingRole, String audiences, String presenter, String producer, String topic, String guest, String reporter, String competition, String subject, String classPeriod, String singer, String screenwriter, String enName, String area, String director, String actors, String language, String airtime, String hImage, String vImage, String description, String UUID, String seriesSum, String grade, String lSuperScript, String rSuperScript, String lSubScript, String rSubScript, String cpCode, String videoSize, String freeDuration, String bitrateStream, String periods, List<MediaCDNInfo> data) {
    ...
    public List<MediaCDNInfo> getData() {
        return data;
    }

    public void setData(List<MediaCDNInfo> data) {
        this.data = data;
    }
