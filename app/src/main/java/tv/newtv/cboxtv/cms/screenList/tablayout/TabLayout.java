package tv.newtv.cboxtv.cms.screenList.tablayout;
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Drawable mStateListDrawable = a.getDrawable(R.styleable.TabLayout_tabIndicatorResId);
        ...
        mIndicatorGravity = a.getInt(R.styleable.TabLayout_tabIndicatorGravity, GRAVITY_BOTTOM);
        mTabStrip.setCircleDotRadius(a.getDimensionPixelOffset(R.styleable.TabLayout_tabCircleDotRadius, 0));
        mTabStrip.setCircleDotColor(a.getColor(R.styleable.TabLayout_tabCircleDotColor, 0));
        mTabStrip.setIndicatorWidth(a.getDimensionPixelOffset(R.styleable.TabLayout_tabIndicatorWidth, 0));
        mTabStrip.setIndicatorHeight(
                a.getDimensionPixelOffset(R.styleable.TabLayout_tabIndicatorHeight, 0));
        mTabStrip.setIndicatorBackgroundColor(a.getColor(R.styleable.TabLayout_tabIndicatorBackgroundColor, 0));
        mTabStrip.setIndicatorBackgroundHeight(a.getDimensionPixelOffset(R.styleable.TabLayout_tabIndicatorBackgroundHeight, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelOffset(R.styleable.TabLayout_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelOffset(R.styleable.TabLayout_tabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelOffset(R.styleable.TabLayout_tabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelOffset(R.styleable.TabLayout_tabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelOffset(R.styleable.TabLayout_tabPaddingBottom,
                mTabPaddingBottom);

        mTabTextSize = a.getDimensionPixelOffset(R.styleable.TabLayout_tabTexSize,
        ...
        mRequestedTabMinWidth = a.getDimensionPixelOffset(R.styleable.TabLayout_tabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelOffset(R.styleable.TabLayout_tabMaxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(R.styleable.TabLayout_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelOffset(R.styleable.TabLayout_tabContentStart, 0);
        mContentInsetBottom = a.getDimensionPixelOffset(R.styleable.TabLayout_tabContentBottom, 0);
        mScrollMode = a.getInt(R.styleable.TabLayout_tabScrollMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.TabLayout_tabGravity, GRAVITY_CENTER);
        a.recycle();
