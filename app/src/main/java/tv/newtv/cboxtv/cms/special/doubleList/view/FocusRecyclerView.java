package tv.newtv.cboxtv.cms.special.doubleList.view;
...
public class FocusRecyclerView extends RecyclerView {
    ...
    public void setOnGetPositionListener(OnGetPositionListener onGetPositionListener) {
        mOnGetPositionListener = onGetPositionListener;
    }

    public interface OnGetPositionListener {
        void GetRightPositionListener(int position);
        void GetLeftPositionListener(int position);
    }
