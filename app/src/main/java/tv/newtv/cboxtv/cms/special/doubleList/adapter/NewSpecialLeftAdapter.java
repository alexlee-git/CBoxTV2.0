...
public class NewSpecialLeftAdapter extends RecyclerView.Adapter<NewSpecialLeftAdapter.LeftHolder> {
    ...
    public NewSpecialLeftAdapter(Context context, List<Program> objectList) {
        this.mNewSpecialDatas = objectList;
        this.context = context;
    }

    public NewSpecialLeftAdapter(Context context, List<Program> objectList, int mDefaultP) {
        this.mNewSpecialDatas = objectList;
        this.context = context;
    ...
    public void refreshData(List<Program> value, String defaultFocus) {
