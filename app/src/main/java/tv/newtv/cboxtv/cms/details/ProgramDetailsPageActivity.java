...
public class ProgramDetailsPageActivity extends BaseActivity implements
    ...
    private void requestData() {
        dataList.clear();
        NetClient.INSTANCE.getDetailsPageApi().getInfo(BuildConfig.APP_KEY, BuildConfig.CHANNEL_ID, leftUUID, rightUUID, contentUUID)
                ...
                .flatMap(new Function<ResponseBody, ObservableSource<ResponseBody>>() {
                    ...
                    public ObservableSource<ResponseBody> apply(ResponseBody value) throws Exception {
                        ...
                        return NetClient.INSTANCE.getListPageApi()
                                .getScreenResult(dataInfo.getVideoType(), BuildConfig.APP_KEY, BuildConfig.CHANNEL_ID, "PS;CG", "",
