 ...
 * 修改备注：
 */
public class AboutHelpFragment extends BaseDetailSubFragment implements ScanScrollView.IScanScrollChangedListener {
    private final String TAG = "AboutHelpFragment";
    ...
    protected int getLayoutId() {
        return R.layout.fragment_usercenter_about_help_v2;
    }

    @SuppressLint({"SetTextI18n", "SetJavaScriptEnabled"})
    @Override
    protected void updateUiWidgets(View view) {
//        mScrollView = (ScanScrollView) view.findViewById(R.id.id_user_about_help_scroll);
//        mScrollView.setScanScrollChangedListener(this);
//        mBottomArrow = (ImageView) view.findViewById(R.id.id_user_help_bottom_arrow);
//        TextView textView = view.findViewById(R.id.about_message);
//        textView.setText("欢迎您使用未来电视New TV平台服务！\n" +
