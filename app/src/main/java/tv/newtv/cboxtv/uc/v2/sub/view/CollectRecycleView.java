package tv.newtv.cboxtv.uc.v2.sub.view;
...
public class CollectRecycleView extends RecyclerView {
    ...
    public CollectRecycleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CollectRecycleView(Context context, AttributeSet attrs, int defStyle) {
