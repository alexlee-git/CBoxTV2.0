 ...
 * 修改备注：
 */
public class UserAgreementActivity extends BaseActivity implements ScanScrollView.IScanScrollChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usercenter_user_agreement_v2);
...
//        mWebView.setWebChromeClient(new MyWebChromeClient());
        ...
        String pageUrl = BootGuide.getBaseUrl(BootGuide.HTML_PATH_MEMBER_PROTOCOL);
