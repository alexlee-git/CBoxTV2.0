...
public class AutoSizeTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void initialize() {
        ...
        DisplayUtils.adjustTextSize(getContext(),this,28);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (view != null) {
            ...
            if (recycleImageView != null) {
                setMeasuredDimension(recycleImageView.getWidth(), getResources()
                        .getDimensionPixelSize(R.dimen.height_40px));
                requestLayout();
                return;
            }
            setMeasuredDimension(view.getMeasuredWidth(), getResources().getDimensionPixelSize(R
                    .dimen.height_40px));
            requestLayout();
            return;
        }
