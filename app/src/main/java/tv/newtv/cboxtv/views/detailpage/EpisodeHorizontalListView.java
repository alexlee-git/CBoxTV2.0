...
import tv.newtv.cboxtv.views.detail.FocusRelativeLayout;
...
public class EpisodeHorizontalListView extends RelativeLayout implements IEpisode {
    ...
    private Content mProgramSeriesInfo;//数据
    ...
    public void initAdapter()
    {
        if(mAdapter==null) {
            mAdapter = new NewTvRecycleAdapter<SubContent, ViewHolder>() {
                ...
                @Override
                public void bind(final SubContent data, final ViewHolder holder, boolean
                        select) {
