...
public class NewTVLauncherPlayerSetting extends FrameLayout implements View.OnKeyListener, View.OnFocusChangeListener {
    ...
    private List<MediaCDNInfo> mMediaCDNInfos;
        ...
        if (event.getAction() == KeyEvent.ACTION_UP) {
            ...
            switch (v.getId()) {
                case R.id.player_setting_size:
                    ...
                    break;
                case R.id.player_setting_sharpness:
                    ...
                    if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
                       ...
                       mNewTVLauncherPlayer.setDataSource(mMediaCDNInfos.get(mSharpnessIndex).getPlayURL());
//                        NewTVLauncherPlayer.getInstance().setDataSource("http://manmanyuntest.vod06.icntvcdn.com/newtv2/2016/11/01/qhsl/qhsl.m3u8");
//                        dismiss();
                    } else if (keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
...
//                        dismiss();
    ...
    public void setData(List<MediaCDNInfo> mediaCDNInfos, int index) {
        Log.i(TAG, "setData: ");
