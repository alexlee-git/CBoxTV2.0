...
public final class ActivityStacks {
    ...
    public void onCreate(BaseActivity activity) {
        synchronized (activities) {
            ...
            if (activity instanceof MainActivity) {
                finishAllActivity();
            } else if (isVideoPlayerActivity(activity)) {
    ...
    private boolean isVideoPlayerActivity(BaseActivity activity) {
        return activity instanceof ColumnPageActivity
                || activity instanceof ProgrameSeriesAndVarietyDetailActivity
                || activity instanceof NewTVLauncherPlayerActivity;
    }
